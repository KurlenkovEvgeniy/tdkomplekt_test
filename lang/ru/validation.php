...
return [
    ...
    'required_without_array_all' => ' Поле :attribute обязательно для заполнения, когда ни один из массивов :values не заполнен.',
    'required_without_array' => ' Поле :attribute обязательно для заполнения, когда массивы :values не заполнены.',
    'required_one_of_array_without_all' => ' Поле :attribute обязательно для заполнения, когда ни одно из других данных полей не заполнено и когда ни одно из :values не заполнено.',
    'required_one_of_array_without' => ' Поле :attribute обязательно для заполнения, когда ни одно из других данных полей не заполнено и когда :values не заполнены.',
    'phone_country_pattern' => ' Поле заполнено не до конца',
];
